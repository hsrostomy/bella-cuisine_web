...
CREATE TABLE `notifications` (
  ...
  `send_to` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `offers` (
  ...
  `link` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `date_added` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
  ...
  `seller_notes` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `promo_codes` (
  ...
  `users_id` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_created` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `transactions` (
  ...
  `order_item_id` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `latitude` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `longitude` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(256) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'phone',
