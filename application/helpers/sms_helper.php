 ...
 *]
 */
function notify_event(string $event,array $emails = [], array $phone = [],  $where = [], $ext_data =[]): array
{
    ...
    foreach ($sendEmail as $email) {
        if ($email != "") {
            // print_r($ext_data);
            if (isset($ext_data) && !empty($ext_data)) {
                # code...
                // print_r("in if ");
                send_mail($email, $title, $t->load->view('admin/pages/view/email-template.php', $ext_data, TRUE));
            } else {
                // print_r("in else");
            ...
            // print_r((send_mail($email, $title, $message, $t->load->view('admin/pages/view/email-template.php', $$ext_data, TRUE))));
            // die;
        }
    }
