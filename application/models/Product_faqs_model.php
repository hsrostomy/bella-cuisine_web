...
class Product_faqs_model extends CI_Model
{
    ...
    public function get_faqs()
    {
        ...
        foreach ($rating_search_res as $row) {
            ...
            // $operate = ' <a href="javascript:void(0)" class="edit_btn btn action-btn btn-success btn-xs mr-1 mb-1" title="View" data-id="' . $row['id'] . '" data-url="admin/product_faqs/"><i class="fa fa-edit"></i></a>';
