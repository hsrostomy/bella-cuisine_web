...
class Payment_request_model extends CI_Model
{
    ...
    function get_payment_request_list()
    {
        ...
        foreach ($offer_search_res as $row) {
            ...
            <a href="javascript:void(0)" class="edit_request dropdown-item" title="Edit" data-target="#payment_request_modal" data-toggle="modal" ><i class="fa fa-pen"></i> Edit</a> </div>';

            // $operate = '<a href="javascript:void(0)" class="edit_request btn action-btn btn-success btn-xs mr-1 mb-1" title="Edit" data-target="#payment_request_modal" data-toggle="modal" ><i class="fa fa-pen"></i></a>';
