...
class Slider_model extends CI_Model
{
    ...
    function get_slider_list()
    {
        ...
        foreach ($slider_search_res as $row) {
            ...
            // $operate = ' <a href="' . base_url('admin/slider?edit_id=' . $row['id']) . '" class="btn action-btn btn-success btn-xs mr-1 mb-1"  title="Edit" data-id="' . $row['id'] . '" data-url="admin/slider/"><i class="fa fa-pen"></i></a>';
            // $operate .= ' <a  href="javascript:void(0)" class="btn action-btn btn-danger btn-xs mr-1 mb-1"  title="Delete" id="delete-slider" data-id="' . $row['id'] . '"  ><i class="fa fa-trash"></i></a>';
