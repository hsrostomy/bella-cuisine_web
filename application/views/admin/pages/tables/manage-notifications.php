                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/Notification_settings/send_notifications'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="start_date" name="start_time" value="<?= isset($flash_sales[0]['start_date']) ? $flash_sales[0]['start_date'] : ''; ?>">
                            <input type="hidden" id="end_date" name="end_time" value="<?= isset($flash_sales[0]['end_date']) ? $flash_sales[0]['end_date'] : ''; ?>">
                            <input type="hidden" id="server_time" name="server_time" value="<?= $curr_time ?>">
                            <?php
                            ...
                            <div class="card-body">
                                ...
                                <div id="type_add_html">
                                    ...
                                    <?php
                                    //  print_r($hiddenStatus); 
                                    ?>
                                    <div class="form-group row notification-flash-sale <?= $hiddenStatus ?>">
                                        <label for="sale_id" class="control-label">Flash sale <span class='text-danger text-sm'>*</span></label>
                                        <div class="col-md-12">
                                            <select name="sale_id" class="form-control">
                                                ...
                                                if (!empty($flash_sales)) {
                                                    foreach ($flash_sales as $flash_sale) {
                                                        $selected = ($flash_sale['id'] == $fetched_data[0]['type_id'] && strtolower($fetched_data[0]['type']) == 'flash_sale') ? 'selected' : '';
                                                ?>
                                                        <option value="<?= $flash_sale['id'] ?>" <?= $selected ?>> <?= $flash_sale['title'] ?></option>
                                                <?php
                                                    }
                                                }
                                                ?>
