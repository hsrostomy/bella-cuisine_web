                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/area/add_area'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="area_name" class="control-label col-md-12 mb-2">Area Name <span class='text-danger text-xs'>*</span></label>
                                    <div class="col-md-6">
                                        <input type="text" class="form-control mb-2" name="area_name" id="area_name" value="<?= (isset($fetched_data[0]['name']) ? $fetched_data[0]['name'] : '') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="city" class="control-label col-md-12 mb-2">City <span class='text-danger text-xs'>*</span></label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="city" class="control-label col-md-12 mb-2">Zipcode <span class='text-danger text-xs'>*</span></label>
                                    <div class="col-md-6">
                                        <select class="form-control mb-2" name="zipcode">
                                ...
                                <div class="form-group row">
                                    <label for="minimum_free_delivery_order_amount" class="control-label col-md-12 mb-2">Minimum Free Delivery Order Amount <span class='text-danger text-xs'>*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control mb-2" name="minimum_free_delivery_order_amount" id="minimum_free_delivery_order_amount" min="0" value="<?= (isset($fetched_data[0]['minimum_free_delivery_order_amount']) ? $fetched_data[0]['minimum_free_delivery_order_amount'] : '') ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="delivery_charges" class="control-label col-md-12 mb-2">Delivery Charges <span class='text-danger text-xs'>*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" class="form-control mb-2" name="delivery_charges" id="delivery_charges" min="0" value="<?= (isset($fetched_data[0]['delivery_charges']) ? $fetched_data[0]['delivery_charges'] : '') ?>">
                                    </div>
                                </div>
