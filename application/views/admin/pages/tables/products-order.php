                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex align-items-center pt-4">
                                        <button type="button" class="btn btn-outline-primary btn-sm text-primary" id="row_order_search" onclick="search_category_wise_products()">Search</button>
                                    </div>
                                </div>
                            </div>
                        </div><!-- .card-innr -->
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-12 offset-md-2">
                                        ...
                                        <div class="row font-weight-bold">
                                            <div class="col-2">Display Order</div>
                                        ...
                                        <ul class="list-group bg-grey move order-container" id="sortable">
                                            ...
                                            ?>
                                                <li class="list-group-item d-flex bg-gray-light align-items-center h-25" id="product_id-<?= $row['id'] ?>">
                                                    ...
                                                    <div class="col-md-3 text-center"><span><?= $row['status'] == 1 ? '<label class="badge bg-success">Active</label>' : '<label class="badge bg-danger">Deactive</label>' ?></span></div>
                                                </li>
                                            <?php
                                                $i++;
                                            }
