                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group px-3 col-md-6">
                                <label for="name" class="control-label col-md-12 mb-2">Bearer Token <small>( Use token for testing purpose in API )</small></label>
                                <div class="col-md-12">
                                    <textarea class="form-control" id="jwt_token" disabled=""><?= $token; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group px-3 col-md-6">
                            ...
                            <div class="form-group px-3 col-md-6">
                                <label for="name" class="control-label col-md-12 mt-2">Admin API Link</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" value="<?= base_url('admin/app/v1/api/'); ?>" disabled>
                                </div>
                            </div>
                            <div class="form-group px-3 col-md-6">
                                <label for="name" class="control-label col-md-12 mt-2">Chat API Link</label>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" value="<?= base_url('app/v1/Chat_Api/'); ?>" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
