                    ...
                    <div class="card content-area p-4">
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/product/create_product' ?>" class="btn btn-block btn-outline-primary btn-sm text-primary">Add Product</a>
                            </div>
                        </div>
                        <div class="card-innr">
                            <div class="card-head ">
                            ...
                            "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="status" data-sortable="false">Active</th>
