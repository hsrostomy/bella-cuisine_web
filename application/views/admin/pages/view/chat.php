    ...
    <div class="main-wrapper main-wrapper-1">
        <section class="content">
            <div class="container-fluid">
                <div id="app">
                    <div class="section-body chat-theme mt-4">
                            ...
                            <div class="navbar-nav nav__list js-nav__list col-12 col-sm-4 col-lg-3">
                                <div class="card chat-theme-light chat-scroll chat-min">
                                    ...
                                    <select name="select_user_id[]" id="chat_user" class="search_user w-100" multiple
                                        ...
                                        ?>
                                        <option value="<?= $user_details[0]['id'] ?>">
                                            <?= $user_details[0]['username'] ?></option>
                                        <?php
                                        }
                                    ...
                                    <div id="add-scroll-js">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border chat-list-unstyled-border">
                                                ...
                                                <li class="media">
                                                    <div class="media-body">
                                                        <div class="chat-person" data-picture="" data-type="person"
                                                            data-id="<?= $user['opponent_user_id'] ?>"><i
                                                                class="<?= ($user['is_online'] == 1) ? 'fas fa-circle text-success' : 'far fa-circle'; ?> "></i>
                                                            <?= $user['opponent_username'] ?> (You)</div>
                                                    </div>
                                                </li>
                                                <?php }
                                                    }
                                                ...
                                                <li class="media">
                                                    <div class="media-body">
                                                        <div data-unread_msg="<?= $user['unread_msg'] ?>"
                                                            class="chat-person <?= ($user['unread_msg'] > 0) ? 'new-msg-rcv' : ''; ?>"
                                                            data-picture="<?= $user['picture'] ?>" data-type="person"
                                                            data-id="<?= $user['opponent_user_id'] ?>"><i
                                                                class="<?= ($user['is_online'] == 1) ? 'fas fa-circle text-success' : 'far fa-circle'; ?> "></i>
                                        ...
                                        <div class="card-header chat-card-header d-flex text-color">
                                            <h4><?= !empty($this->lang->line('support_chat')) ? $this->lang->line('support_chat') : 'Support Team '; ?>
                                            </h4>
                                        </div>
                                        <div class="chat-card-body">
                                            <ul class="list-unstyled list-unstyled-border chat-list-unstyled-border">
                                                ...
                                                <li class="media">
                                                    <div class="media-body">
                                                        <div class="chat-person"
                                                            data-id="<?= $supporter['userto_id'] ?>" data-type="person">
                                                            <i
                                                                class="<?= ($supporter['is_online'] == 1) ? 'fas fa-circle text-success' : 'far fa-circle'; ?> "></i>
                                                            <?= $supporter['username'] ?>
                                                        </div>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="card-body d-none" id="chat-dropbox">
                                        ...
                                        <div class="text-center mt-3">
                                            <button class="btn btn-danger shadow-none"
                                                onclick="closeDropZone();"><?= !empty($this->lang->line('label_close')) ? $this->lang->line('label_close') : 'Close'; ?>
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row mt-2">
                                                <span class="input-group-append ">
                                                    <div class="form-group">
                                                        ...
                                                        <button class="btn-file btn btn-primary"
