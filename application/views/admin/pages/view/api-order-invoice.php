                ...
                <div class="card card-info " id="section-to-print">
                    ...
                    <div class="row m-3 d-flex justify-content-between">
                        ...
                        <div class="col-sm-4 invoice-col">To <address>
                                ...
                                <?php 
                                if (isset($order_detls[0]['mobile']) && !empty($order_detls[0]['mobile']) && $order_detls[0]['mobile'] != "" && $order_detls[0]['mobile'] != " ") {
                                    $mobile = (defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0) ? str_repeat("X", strlen($order_detls[0]['mobile']) - 3) . substr($order_detls[0]['mobile'], -3) : $order_detls[0]['mobile'];
                                }else{
                                    $mobile = "";
                                }
                                if (isset($order_detls[0]['recipient_contact']) && !empty($order_detls[0]['recipient_contact']) && $order_detls[0]['recipient_contact'] != "" && $order_detls[0]['recipient_contact'] != " ") {
                                ...
                                <tbody>
                                    ...
                                    foreach ($items as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= ($row['tax_percent']) ? (($row['product_special_price'] * $row['tax_percent']) / 100) . '(' . $row['tax_percent'] . '%)' : '0(0%)' ?><br></td>
                                            <br>
                                        ...
                                        <?php if ($row['type'] != 'digital_product') { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php $final_total = $final_sub_total - $order_detls[0]['discount'] - $order_detls[0]['promo_discount'] + $order_detls[0]['delivery_charge']; ?>
