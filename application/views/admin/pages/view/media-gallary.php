                ...
                <div class="col-12 border-bottom">
                    <div class="col-lg-9 col-md-8">
                        <div class="section-title">
                            <h4 class="title mb-2">Media Gallary</h4>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <div class="row mt-2">
                                <div class="col-md-4 d-flex align-items-center pt-3">
                                    <button type="button" class="btn btn-outline-primary btn text-primary" onclick="status_date_wise_search()" class="margin-right-10px">Search</button>
                                    <button type="button" class="btn btn-outline-danger btn" onclick="resetfilters()">Reset</button>
                                </div>
