<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-sm  mt-4 bg-white navbar-dark flex-column flex-md-row rounded">
                <ul class="navbar-nav flex-row d-md-flex ">
                    <li class="nav-item">
                        <a class="nav-link text-secondary" href="">All Products</a>
                    </li>
                    <!-- Dropdown -->
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <section class="container content-section mt-4">
                                <form id="pos_form" method="post" action='<?= base_url('admin/point_of_sale/place_order') ?>'>
                                    ...
                                    <div>
                                        <p class="h5 text-primary">Delivery type</p>
                                        <div class="mt-4 self_pickup">
                                            <label for="local_pickup">
                                                <input id="local_pickup" type="radio" name="self_pickup[]" value="1" class="self_pickup" checked />
                                                Local Pickup
                                            </label>
                                        </div>
                                        <div class="self_pickup">
                                            <label for="door_step_delivery">
                                                <input id="door_step_delivery" type="radio" name="self_pickup[]" value="0" class="self_pickup" />
                                                Door Step Delivery
                                            </label>
                                        </div>
            ...
            <div class="modal-body">
                <form method="post" action='<?= base_url('admin/point_of_sale/register_user') ?>' id="register_form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" maxlength="16" oninput="validateNumberInput(this)" class="form-control" id="mobile" placeholder="Enter Your Mobile Number" name="mobile">
                    </div>
                    <div class="form-group">
                        <label for="password">Password:</label>
                        <input type="text" class="form-control" id="password" value="12345678" placeholder="Enter Password" name="password">
                    </div>
                    <button type="submit" class="btn btn-primary mt-4" id="save-register-result-btn" name="register" value="Save">Register</button>
                    <div class="mt-3">
