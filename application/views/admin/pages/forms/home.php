                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                ...
                                <div class="media-body text-right me-3">
                                    <h5 class="text-muted text-bold-500 card-h5-style mx-2">Orders</h5>
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                ...
                                <div class="media-body text-right me-3">
                                    <h5 class="text-muted text-bold-500 card-h5-style mx-2">New Signups</h5>
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                ...
                                <div class="media-body text-right me-3">
                                    <h5 class="text-muted text-bold-500 card-h5-style mx-2">Delivery Boys</h5>
                    ...
                    <div class="card card-style">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify justify-content-md-between">
                                <div class="align-self-center text-info card-icon-div">
                                    <i class="ion-ios-albums-outline display-4 display-4"></i>
                                </div>
                                <div class="media-body text-right me-3">
                                    <h5 class="text-muted text-bold-500 card-h5-style mx-2">Products</h5>
                            ...
                            <div class="gaps-1-5x row d-flex adjust-items-center">
                                <div class="row col-md-12">
                                    ...
                                    <div class="form-group col-md-1 d-flex align-items-center pt-4">
                                        <button type="button" class="btn btn-outline-primary btn-sm text-primary" onclick="status_date_wise_search()">Filter Orders</button>
                                    </div>
                                </div>
                            </div>
