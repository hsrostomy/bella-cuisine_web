                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/attribute_value/add_attribute_value'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="align-items-center d-flex form-group mb-2">
                                ...
                                <div class="align-items-center d-flex form-group mb-2" id="swatche_color" <?= $no_display_color  ?>>
                                ...
                                <div class="align-items-center d-flex form-group mb-2" id="swatche_image" <?= $no_display_image  ?>>
