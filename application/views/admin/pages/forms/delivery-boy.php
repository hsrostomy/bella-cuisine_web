                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/delivery_boys/add_delivery_boy'); ?>" method="POST" id="add_product_form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mt-1">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="mobile" placeholder="Enter Mobile" maxlength="16" oninput="validateNumberInput(this)" name="mobile" value="<?= @$fetched_data[0]['mobile'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mt-1">
                                ...
                                <div class="form-group row mt-1 fixed_amount_per_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['bonus_type'] == 'fixed_amount_per_order') ? '' : 'd-none' ?>">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min='1' class="form-control" id="bonus_amount" placeholder="Enter amount to be given to the delivery boy on successful order delivery" name="bonus_amount" value="<?= @$fetched_data[0]['bonus'] ?>">
                                    </div>
                                </div>
