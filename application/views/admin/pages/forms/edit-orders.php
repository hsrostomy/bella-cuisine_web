                            ...
                            ?>
                                <div class="swiper-slide">
                                    <div class="max-auto col-md-6 offset-md-3">
                                        <div class="<?= $status_wise_class[$row[0]][1] ?> pt-2 pb-2 rounded"> <span class="fa-lg"><i class="<?= $status_wise_class[$row[0]][0] ?>"></i></span>
                                        </div>
                                    </div>
                                    ...
                                    <td>
                                        <?php foreach ($items as $item) {
                                            if (isset($item['product_type']) && ($item['product_type'] != 'digital_product')) { ?>
                                                <?php if (isset($shiprocket_settings['shiprocket_shipping_method']) && $shiprocket_settings['shiprocket_shipping_method'] == 1) { ?>
                                                    <div class="row mb-1">
                                                        <div class="col-12">
                                                            <button type="button" disabled class="btn btn-primary float-right create_shiprocket_order" data-target="#order_parcel_modal" data-toggle="modal"> Create
                                        ...
                                        ?>
                                            <div class="card col-md-3 col-sm-12 p-3 mb-2 bg-white rounded m-1 grow">
                                                        ...
                                                        <div class="row mt-2 order_status">
                                                            <div class="col-md-7 text-center">
                                                                ...
                                                                <select class="form-control-sm w-100">
                                                                    <?php if (isset($items[0]['product_type']) && $items[0]['product_type'] == 'digital_product') { ?>
                                                                        <option value="delivered" <?= (strtolower($item['active_status']) == 'delivered') ? 'selected' : '' ?>>
                                                                            delivered</option>
                                                                    <?php } else { ?>
                                                                        <option value="processed" <?= (strtolower($item['active_status']) == 'processed') ? 'selected' : '' ?>>
                                                                            Processed</option>

                                                                        <?php if ($order_detls[0]['is_local_pickup'] == 0) { ?>
                                                                            <option value="shipped" <?= (strtolower($item['active_status']) == 'shipped') ? 'selected' : '' ?>>
                                                                                Shipped</option>
                                                                        <?php } else { ?>
                                                                            <option value="ready_to_pickup" <?= (strtolower($item['active_status']) == 'ready_to_pickup') ? 'selected' : '' ?>>
                                                                                Ready To Pickup</option>
                                                                        <?php } ?>
                                                                        <option value="delivered" <?= (strtolower($item['active_status']) == 'delivered') ? 'selected' : '' ?>>
                                                                            delivered</option>
                                                                        <option value="returned" <?= (strtolower($item['active_status']) == 'returned') ? 'selected' : '' ?>>
                                                                            Return</option>
                                                                        <option value="cancelled" <?= (strtolower($item['active_status']) == 'cancelled') ? 'selected' : '' ?>>
                                                                            Cancel</option>
                                                                    <?php  } ?>
                                                                </select>
                                                            </div>
                                                ...
                                                <div><span class="text-bold">Discounted Price : </span>
                                                ...
                                                <div><span class="text-bold">Active Status : </span> <span class="badge badge-<?= $badges[$item['active_status']] ?>"> <small class="text-bold active_class_badge"><?php print_R(str_replace('_', ' ', $item['active_status'])) ?></small></span>
                                                </div>
                                            </div>
                                        <?php
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="mt-1 p-2 bg-danger text-white rounded">
                                            <p><b>Note:</b> Make your pickup location associated with the order is
                                                verified from <a href="https://app.shiprocket.in/company-pickup-location?redirect_url=" target="_blank" class="text-decoration-underline color-white">
                                                    Shiprocket Dashboard </a> and then in <a href="<?php base_url('admin/Pickup_location/manage-pickup-locations'); ?>" target="_blank" class="text-decoration-underline color-white"> admin
