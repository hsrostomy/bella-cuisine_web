            ...
            <div class="row">
                <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST" enctype="multipart/form-data" id="save-product">
                    ...
                    <div class="col-md-12">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6 mt-3">
                                                        ...
                                                        <input name='tags' class='' id='tags' placeholder="Enter product tags" value="<?= (isset($product_details[0]['tags']) && !empty($product_details[0]['tags'])) ? $product_details[0]['tags'] : "" ?>" />
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <select class="col-md-12 form-control" name="pro_input_tax">
                                                                ...
                                                                ?>
                                                                    <option value="<?= $row['id'] ?>" <?= $selected ?>><?= $row['title'] ?><?= $row['status'] ?><?php echo "(" . $row['percentage'] . "%)" ?></option>
                                                                <?php
                                                                } ?>
                                                            </select>
                                                        </div>

                                                        <div class="form-group col-md-6 mt-4 d-flex justify-content-between">
                                                            <label for="is_cod_allowed" class="col-form-label">Tax included in prices?</label>
                                                            <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="is_prices_inclusive_tax" <?= (isset($product_details[0]['is_prices_inclusive_tax']) && $product_details[0]['is_prices_inclusive_tax'] == '1') ? 'checked' : '' ?> /></a>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6">
                                                                ...
                                                                <select class='form-control' name='video_type' id='video_type'>
                                                                    ...
                                                                    <option value='vimeo' <?= (isset($product_details[0]['video_type']) &&  $product_details[0]['video_type'] == 'vimeo') ? 'selected' : ''; ?>>Video</option>
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="col-md-12 <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == 'self_hosted')) ? '' : 'd-none'; ?>" id="video_media_container">
                                                                <label for="image">Video <span class='text-danger text-sm'>*</span></label>
                                                                <div class='col-md-12 border refer_and_earn_border'><a class="" data-input='pro_input_video' data-isremovable='1' data-media_type="video" data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='bx bx-image-add box-icon-height'></i> </a> <br><b>Drop your Video here, or</b> browse<br> </div>
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <div class="col-md-12 form-group">
                                                    <div class="col-md-12 form-group mt-4">
                                                        <b>Main Image</b>
                                                        <div class="">
                                                            <div class='col-md-12 border refer_and_earn_border'><a class="" data-input='pro_input_image' data-isremovable='0' data-is-multiple-uploads-allowed='0' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='bx bx-image-add box-icon-height'></i> </a> <br><b>Drop your image here, or</b> browse<br> Recommended Size : 180 x 180 pixels<br></div>
                                                            <?php
                                                            if (isset($product_details[0]['id']) && !empty($product_details[0]['id'])) {
                                                            ?>
                                                                <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                                <div class="container-fluid row image-upload-section ">
                                                                    <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image w-auto">
                                                    ...
                                                    <div class="col-md-12 form-group mt-4">
                                                        <b>Other Images</b>
                                                        <div class="">
                                                            <div class='col-md-12 border refer_and_earn_border'><a class="" data-input='other_images[]' data-isremovable='1' data-is-multiple-uploads-allowed='1' data-toggle="modal" data-target="#media-upload-modal" value="Upload Photo"><i class='bx bx-image-add box-icon-height'></i> </a> <br><b>Drop your image here, or</b> browse<br> Recommended Size : 180 x 180 pixels<br></div>
                                                            <?php
                                                            if (isset($product_details[0]['id']) && !empty($product_details[0]['id'])) {
                                                            ?>
                                                                <div class="container-fluid row image-upload-section">
                        ...
                        <div class="col-md-12  mt-4 product_qty">
                            <div class="row">
                                <div class=" mt-4 ">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="card card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <div class="indicator <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class=" total_allowed_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="total_allowed_quantity" class="col-form-label">Total Allowed Quantity</label>
                                                                <input type="number" min="1" class="col-md-12 form-control" name="total_allowed_quantity" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : '1'; ?>" placeholder='Total Allowed Quantity'>
                                                            </div>
                                                        </div>

                                                        <div class="form-group col-md-6 ">
                                                            <div class="minimum_order_quantity <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class="warranty_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class="guarantee_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div class="quantity_step_size <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                        ...
                        <div class="col-md-12  mt-4 delivery_settings">
                            <div class="row">
                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <div class="mt-2">
                                                                                ...
                                                                                // print_r($cities);
                                                                                ?>
                                                                                <select class="form-control city_list" name="deliverable_cities[]" id="deliverable_cities" multiple <?= (isset($product_details[0]['deliverable_city_type']) && ($product_details[0]['deliverable_city_type'] == INCLUDED || $product_details[0]['deliverable_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="shipping_type" class="col-form-label">For standard shipping <span class='text-danger text-sm'>*</span></label>
                                                        ...
                                                        <div class="form-group col-md-12 d-flex justify-content-between mt-4">
                                                            <div class="col-md-4 cod_allowed d-flex justify-content-between mt-1<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_cod_allowed" class="col-form-label">Is COD allowed?</label>
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="cod_allowed" <?= (isset($product_details[0]['cod_allowed']) && $product_details[0]['cod_allowed'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>


                                                            <div class="col-md-4  is_returnable d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_returnable" class="col-form-label">IS Returnable ?</label>
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="is_returnable" <?= (isset($product_details[0]['is_returnable']) && $product_details[0]['is_returnable'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>
                                                        ...
                                                        <div class="form-group col-md-12 d-flex justify-content-between  mt-4">
                                                            <div class="col-md-4 is_cancelable  d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_cancelable" class="col-form-label">Is cancelable ? </label>
                                                                <!-- <input type="checkbox" name="is_cancelable" id="is_cancelable" class="switch" <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == '1') ? 'Checked' : ''; ?> data-bootstrap-switch> -->
                                                                <a class="form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input" role="switch" id="is_cancelable" name="is_cancelable" <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == '1') ? 'Checked' : '' ?> /></a>
                                                            ...
                                                            <div class="col-md-4  is_attachment_required d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                ...
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="is_attachment_required" <?= (isset($product_details[0]['is_attachment_required']) && $product_details[0]['is_attachment_required'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>

                                                        </div>

                                                        <div class="form-group col-md-8 d-flex justify-content-between  mt-4">
                                                            <div class="col-md-6 col-xs-6 <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == 1) ? '' : 'collapse' ?>" id='cancelable_till'>
                                                                            ...
                                                                            <div id='product-general-settings'>
                                                                                ...
                                                                                ?>
                                                                                    <div id="general_price_section">
                                                                                        ...
                                                                                        <div class="form-group row mt-4 dimensions  <?=
                                                                                                                                    $product_details[0]['type'] == "digital_product" ? 'd-none' : '' ?>">
                                                                                            <div class="col-3">
                                                                                                <label for="weight" class="control-label col-md-12">Weight <small>(kg)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                <input type="number" class="form-control" min="0" name="weight" placeholder="Weight" id="weight" value="<?= $product_variants[0]['weight'] ?>" step="0.01">
                                                                                            </div>
                                                                                            <div class="col-3">
                                                                                                <label for="height" class="control-label col-md-12">Height <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                <input type="number" class="form-control" min="0" name="height" placeholder="Height" id="height" value="<?= $product_variants[0]['height'] ?>">
                                                                                            </div>
                                                                                            <div class="col-3">
                                                                                                <label for="breadth" class="control-label col-md-12">Breadth <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                <input type="number" class="form-control" min="0" name="breadth" placeholder="Breadth" id="breadth" value="<?= $product_variants[0]['breadth'] ?>">
                                                                                            </div>
                                                                                            <div class="col-3">
                                                                                                <label for="length" class="control-label col-md-12">Length <small>(cms)</small> <span class='text-danger text-xs'>*</span></label>
                                                                                                <input type="number" class="form-control" min="0" name="length" placeholder="Length" id="length" value="<?= $product_variants[0]['length'] ?>">
                                                                                            </div>
                                                                                        </div>
                                    ...
                                    variant-stock-level-type" data-placeholder=" Type to search and select type">
                                                                        ...
                                                                        <div class="tab-pane fade" id="product-attributes" role="tabpanel" aria-labelledby="product-attributes-tab">
                                                                            <div class="info col-12 p-3 d-none" id="note">
                                                                                <div class=" col-12 d-flex align-center gap-4">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <a href="javascript:void(0);" id="add_attributes" class="btn btn-block btn-outline-primary col-md-2 float-right m-2 text-black">Add Attributes</a>
                                                                                <a href="javascript:void(0);" id="save_attributes" class="btn btn-block btn-outline-primary col-md-2 float-right m-2  d-none text-black">Save Attributes</a>
                                                                            </div>
                                                                            ...
                                                                            <div class="row mt-4 col-md-12 ">
                                                                                ...
                                                                                <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                                    <div class="tab-pane fade active show" id="general-settings" role="tabpanel" aria-labelledby="general-settings-tab">
                                                                                        ...
                                                                                        <div id="product-general-settings">
                                                                                            <div id="general_price_section" class="collapse">
                                                                                                ...
                                                                                                <div class="form-group" id="stock-management">
                                                                                                    <div class="col">
                                                                                    ...
                                                                                    <div class="tab-pane fade" id="product-attributes" role="tabpanel" aria-labelledby="product-attributes-tab">
                                                                                        ...
                                                                                        <div class="col-md-12"> <a href="javascript:void(0);" id="add_attributes" class="btn btn-block text-black btn-outline-primary col-md-2 float-right m-2 ">Add Attributes</a> <a href="javascript:void(0);" id="save_attributes" class="btn btn-block btn-outline-primary text-black float-right m-2  d-none">Save Attributes</a>
                                                                                        </div>
                                                                                        <div class="clearfix"></div>
                                                                                        <div id="attributes_process">
                                                                                            <div class="form-group text-center row my-auto p-2 border rounded bg-gray-light col-md-12 no-attributes-added">
                            ...
                            <div class="col-md-12  mt-4">
                                <div class="row">
                                    ...
                                    <div class="form-group mt-4 d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success ml-2" id="submit_btn"><?= (isset($product_details[0]['id'])) ? 'Update Product' : 'Add Product' ?></button>
                                    </div>
                                </div>
                            </div>
