                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="tab-content w-100" id="nav-tabContent">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12 description">
                                                                    <div class="form-group col-md-12">
                                                                        <div class="mb-3">
                                                                            <textarea name="text_format_data" class="text_format_data" rows="5" placeholder="Place some text here" style="resize: both;"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <!-- sms matrix -->
                            <div class="tab-pane fade " id="sms-matrix" role="tabpanel" aria-labelledby="sms-matrix-tab">
                                <div class="align-items-center">
                                    <form class="form-horizontal form-submit-event update_notification_module" action="<?= base_url('admin/Sms_gateway_settings/update_notification_module'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                                        <div class=" row">
                                            <div class="table-responsive table-responsive-sm">
                                                <?php
                                                $actions = [
                                                    'customer', 'admin', 'delivery_boy', 'notification_via_sms', 'notification_via_mail'
                                                ];
                                                ?>
                                        ...
                                        <div class="card card-info">
                                            ...
                                            <form class="form-horizontal form-submit-event add_sms" action="<?= base_url('admin/custom_sms/add_sms'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                                                ...
                                                <div class=" card-body">
                                                    ...
                                                    <div class="form-group row mb-3 place_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'place_order') ? '' : 'd-none' ?>">
                                                    ...
                                                    <div class="form-group row mb-3 settle_cashback_discount <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'settle_cashback_discount') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_received <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_received') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_processed <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_processed') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_shipped <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_shipped') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_delivered <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_delivered') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_cancelled <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_cancelled') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_returned <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_returned') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_returned_request_approved <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_returned_request_approved') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 customer_order_returned_request_decline <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'customer_order_returned_request_decline') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 wallet_transaction <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'wallet_transaction') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 ticket_status <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'ticket_status') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                    ...
                                                    <div class="form-group row mb-3 ticket_message <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'ticket_message') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = ['< application_name >'];
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 bank_transfer_receipt_status <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'bank_transfer_receipt_status') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
                                                    ...
                                                    <div class="form-group row mb-3 bank_transfer_proof <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['type'] == 'bank_transfer_proof') ? '' : 'd-none' ?>">
                                                        <label for="message" class="col-sm-2 col-form-label"></label></label>
                                                        <?php
                                                        $hashtag = get_notification_variables();
                                                        foreach ($hashtag as $row) { ?>
