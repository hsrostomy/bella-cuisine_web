                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" id="update-language-form" action="<?= base_url('admin/language/save'); ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="mb-2" for="detail_2" class="control-checkbox"> To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.</label>
                                            <input type="text" name="detail_2" class="form-control mb-2" value="<?= (isset($lang_labels['detail_2']) && !empty($lang_labels['detail_2'])) ? $lang_labels['detail_2'] : '  To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="mb-2" for="detail_4" class="control-checkbox"> To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.</label>
                                            <input type="text" name="detail_4" class="form-control mb-2" value="<?= (isset($lang_labels['detail_4']) && !empty($lang_labels['detail_4'])) ? $lang_labels['detail_4'] : '  To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="mb-2" for="detail_5" class="control-checkbox"> To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.</label>
                                            <input type="text" name="detail_5" class="form-control mb-2" value="<?= (isset($lang_labels['detail_5']) && !empty($lang_labels['detail_5'])) ? $lang_labels['detail_5'] : '  To short sentences, to many headings, images too large for the proposed design, or too small, or they fit in but it looks iffy for reasons the folks in the meeting can’t quite tell right now, but they’re unhappy, somehow.'; ?>" />
                                        </div>
                                    </div> -->
                                    <div class="col-md-6">
                                        <div class="form-group">
