                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="mobile" placeholder="Type Mobile Number here" name="mobile" maxlength="16" oninput="validateNumberInput(this)" value="<?= $users->mobile ?>">
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="form-group row mb-4">
