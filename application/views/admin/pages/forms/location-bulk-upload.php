                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/area/process_bulk_upload'); ?>" method="POST" id="location_bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="file" name="upload_file" class="form-control mb-2" accept=".csv" />
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="card-body pad">
                                        <div class="form-group zipcode_samples">
                                            <a href="<?= base_url('uploads/zipcodes-bulk-upload-sample.csv') ?>" class="btn btn-info" download="zipcodes-bulk-upload-sample.csv">Zipcode Bulk upload sample file <i class="fas fa-download"></i></a>
                                            <a href="<?= base_url('uploads/zipcodes-bulk-update-sample.csv') ?>" class="btn btn-info" download="zipcodes-bulk-update-sample.csv">Zipcode Bulk update sample file <i class="fas fa-download"></i></a>
                                        </div>
                                        <div class="form-group city_samples">
                                            <a href="<?= base_url('uploads/cities-bulk-upload-sample.csv') ?>" class="btn btn-info" download="cities-bulk-upload-sample.csv">Cities Bulk upload sample file <i class="fas fa-download"></i></a>
                                            <a href="<?= base_url('uploads/cities-bulk-update-sample.csv') ?>" class="btn btn-info" download="cities-bulk-update-sample.csv">Cities Bulk update sample file <i class="fas fa-download"></i></a>
                                        </div>
                                        <div class="form-group area_samples">
                                            <a href="<?= base_url('uploads/areas-bulk-upload-sample.csv') ?>" class="btn btn-info" download="areas-bulk-upload-sample.csv">Area Bulk upload sample file <i class="fas fa-download"></i></a>
                                            <a href="<?= base_url('uploads/areas-bulk-update-sample.csv') ?>" class="btn btn-info" download="areas-bulk-update-sample.csv">Area Bulk update sample file <i class="fas fa-download"></i></a>
                                        </div>
                                        <div class="form-group">
