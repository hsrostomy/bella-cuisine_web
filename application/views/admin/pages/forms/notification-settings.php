                                ...
                                <div class="form-group">
                                    <div class="card-body">
                                        <div class="form-group mb-0">
                                            ...
                                            <!-- <textarea class="form-control" name="firebase_project_id" placeholder='Firebase Project ID' rows="5">
                                                <?= (isset($firebase_project_id) && !empty($firebase_project_id)) ? $firebase_project_id : '' ?></textarea> -->
