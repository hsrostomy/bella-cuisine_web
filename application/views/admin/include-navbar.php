    ...
    <div class="navbar-nav-right d-flex flex-wrap align-items-center mt-auto" id="navbar-collapse">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto flex-wrap">
            ...
            <li class="nav-item dropdown mx-2">
                <a href="javascript:void(0);" data-toggle="dropdown" id="notification_count" class="nav-link notification-toggle nav-link-lg" data-toggle="dropdown">
                    <i class="fas fa-bell fa-2x"></i>
                    <span class="badge bg-danger navbar-badge order_notification"><?= $count_noti[0]['total'] ?></span>
                </a>
