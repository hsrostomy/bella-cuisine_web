...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="<?= base_url('admin/home') ?>" class="app-brand-link">
            ...
            <span class="brand-text  fw-bolder ms-2" style="color: #6133BD;"><?= $settings['app_name']; ?></span>
    ...
    <ul class="menu-inner py-1 ps ps--active-y">
       ...
       with font-awesome or any other icon font library -->
        ...
        <!-- <div class="google_translate_element_2"></div> -->
        ...
        <!-- blog -->
        <!-- <li class="menu-item <?= ($current_url == base_url('admin/blogs') || ($current_url == base_url('admin/blogs'))) ? 'active open' : '' ?>">
            <a href="#" class="menu-link menu-toggle">
                <i class="ion-icon-disc-outline text-primary"></i>
                <div data-i18n="Layouts">Blogs</div>
            </a>
            <ul class="menu-sub">
                    <li class="menu-item <?= ($current_url == base_url('admin/blogs')) ? 'active' : '' ?>">
                        <a href="<?= base_url('admin/blogs') ?>" class="menu-link">
                            <div data-i18n="Without menu">Blog Categories</div>
                        </a>
                    </li>
                    <li class="menu-item <?= ($current_url == base_url('admin/blogs/manage_blogs')) ? 'active' : '' ?>">
                        <a href="<?= base_url('admin/blogs/manage_blogs') ?>" class="menu-link">
                            <div data-i18n="Without menu">Create blog</div>
                        </a>
                    </li>
            </ul>
        </li> -->
