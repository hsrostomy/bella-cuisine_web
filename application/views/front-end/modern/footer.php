...
<footer>
    <div class="container-fluid p-0 border-top bg-white">
                    ...
                    <?php if (isset($web_settings['address']) && !empty($web_settings['address'])) { ?>
                        <li class="nav-item d-flex ">
                            ...
                            <div class="default-cursor">
                                <h5 class="fw-bold"><?= !empty($this->lang->line('find_us')) ? $this->lang->line('find_us') : 'Find Us' ?></h5>
                    ...
                    <?php if (isset($web_settings['support_number']) && !empty($web_settings['support_number'])) { ?>
                        <a href="tel:<?= $web_settings['support_number'] ?>" class="text-reset text-decoration-none">
                            <li class="nav-item d-flex ">
                                ...
                                <div class="default-cursor">
                                    <h5 class="fw-bold"><?= !empty($this->lang->line('call_us')) ? $this->lang->line('call_us') : 'Call us' ?></h5>
                    ...
                    <?php if (isset($web_settings['support_email']) && !empty($web_settings['support_email'])) { ?>
                        <a href="mailto:<?= $web_settings['support_email'] ?>" class="text-reset text-decoration-none">
                            <li class="nav-item d-flex ">
                                ...
                                <div class="default-cursor">
                                    <h5 class="fw-bold"><?= !empty($this->lang->line('mail_us')) ? $this->lang->line('mail_us') : 'Mail us' ?></h5>
                    ...
                    <div class="row justify-content-around ps-md-4">
                        <div class="col-4 pe-1 default-cursor">
                            ...
                            <a href="<?= base_url('home/about-us') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('about_us')) ? $this->lang->line('about_us') : 'About Us' ?></p>
                            </a>
                            <a href="<?= base_url('home/system-contact-us') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('contact_us')) ? $this->lang->line('contact_us') : 'Contact Us' ?></p>
                            </a>
                            <a href="<?= base_url('products') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('products')) ? $this->lang->line('products') : 'Products' ?></p>
                            </a>
                            <a href="<?= base_url('home/categories') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('categories')) ? $this->lang->line('categories') : 'Categories' ?></p>
                            </a>
                        </div>
                        <div class="col-4 pe-1 default-cursor">
                            <h5><?= label('legal', 'Legal') ?></h5>
                            <a href="<?= base_url('home/privacy-policy') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('privacy_policy')) ? $this->lang->line('privacy_policy') : 'Privacy Policy' ?></p>
                            </a>
                            <a href="<?= base_url('home/terms-and-conditions') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('terms_and_condition')) ? $this->lang->line('terms_and_condition') : 'Terms & Conditions' ?></p>
                            </a>
                            <a href="<?= base_url('home/return-policy') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('return_policy')) ? $this->lang->line('return_policy') : 'Return Policy' ?></p>
                            </a>
                            <a href="<?= base_url('home/shipping-policy') ?>" class="text-reset text-decoration-none">
                                <p class="m-0"><?= !empty($this->lang->line('shipping_policy')) ? $this->lang->line('shipping_policy') : 'Shipping Policy' ?></p>
                            </a>
                        </div>
        ...
        <div class="copyright-section default-cursor">
            ...
            ?>
                <span><?= (isset($web_settings['copyright_details']) && !empty($web_settings['copyright_details'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $web_settings['copyright_details'])) : " " ?></span>
            <?php } else { ?>
...
<div class="fixed-icon">
    <?php if ($this->ion_auth->logged_in()) { ?>
        ...
        <iframe src="<?= base_url('my-account/floating_chat_modern') ?>" id="chat-iframe" style="display: none; position: fixed; bottom: 80px; right: 20px; width: 450px; height: 600px; border: none;z-index:999; background: white;"></iframe>
    <?php } ?>
