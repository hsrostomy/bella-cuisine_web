<main>
    <section class="container py-5 text-center">
        <div class="w-100 height-50vh">
            <lottie-player src="https://assets7.lottiefiles.com/packages/lf20_evNjeW.json" background="transparent" speed="1" class="w-100 height-50vh" autoplay></lottie-player>
        </div>
