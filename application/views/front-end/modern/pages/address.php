                ...
                <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form">
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="address" id="address" rows="3" placeholder="<?= !empty($this->lang->line('address')) ? $this->lang->line('address') : 'Address' ?>"></textarea>
                        </div>
                        <div class="mb-3 col-md-12">
                            <label for="country" class="form-label"><?= label('country', 'Country') ?> <sup class="text-danger fw-bold">*</sup></label>
                            <input type="text" class="form-control" id="country" name="country" placeholder="<?= !empty($this->lang->line('country')) ? $this->lang->line('country') : 'Country' ?>">
                        </div>
                        <div class="mb-3 col-md-12">
                        ...
                        <!-- <div class="mb-3 col-md-12 city">
                            ...
                            <div class="form-control">
                                <select id="city" name="city_id" class=" me-2 opacity-0" type="text" aria-label="Search">City</select>
                            </div>
                            <p class="fs-7 m-0 text-danger">If Your City Is Not In List Select Other</p>
                        </div> -->
                        <div class="col-md-12 form-group city">
                            <label for="city" class="control-label"><?= !empty($this->lang->line('city')) ? $this->lang->line('city') : 'City' ?></label>
                            <select class="form-control" name="city_id" id="city">
                                <option value="" placeholder="<?= !empty($this->lang->line('select_city')) ? $this->lang->line('select_city') : 'Select City' ?>"></option>
                                <?php foreach ($cities as $row) { ?>
                                    <option value="<?= $row['id'] ?>"><?= $row['name'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="mb-3 col-md-12 area">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="area" data-sortable="false">
                                <?= !empty($this->lang->line('area')) ? $this->lang->line('area') : 'Area' ?></th>
