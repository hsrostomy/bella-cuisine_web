        ...
        <div class="row">
            ...
            <div class="col-md-9 padding-16-30">
                <div class="dashboard-text">
                    ...
                    <p><?= label('from_your_account_dashboard_you_can_view_your', 'From your account dashboard you can view your')?><a href="<?= base_url('my-account/orders') ?>"> <?= label('recent_orders', 'recent orders')?></a>,<?= label('manage_your', 'manage your')?><a href="<?= base_url('my-account/manage-address') ?>"><?= label('shipping_and_billing_addresses', 'shipping and billing addresses')?></a>,<?= label('and', 'And')?>
                    <a href="<?= base_url('my-account/profile') ?>"><?= label('edit_your_password_and_account_details', 'edit your password and account details.')?></a></p>
                        ...
                        <div class="col-md-4 col-12 dashboard-links-container">
                            <a href="<?= base_url('my-account/profile') ?>">
                                <div class="p-3">
                                    ...
                                    <p class="m-0"><?= label('account_detail', 'Account Details') ?></p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-4 col-12 dashboard-links-container">
