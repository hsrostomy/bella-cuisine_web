                                    ...
                                    <div class="col-md-3 col-sm-6 mt-5">
                                        <div class="product-grid">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <a class="add-to-cart add_to_cart" href="" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-izimodal-open="<?= $modal ?>"><?= label('add_to_cart', '+ Add To Cart') ?></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php }
