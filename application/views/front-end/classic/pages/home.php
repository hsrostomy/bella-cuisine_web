...
<section class="main-content mt-md-2 mt-sm-0">
            ...
            <div class="mb-4 mb-md-5">
                <div class="my-4 featured-section-title">
                    <div class="row">
                        ...
                        <div class="col-12 text-right"><a href="<?= base_url('home/brands/') ?>" class="featured-section-view-more"><?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'See All' ?></a>
                        </div>
                    </div>
                    <hr>
                </div>
                                        ...
                                        <div class="product-image">
                                            ...
                                            <?php if (isset($product_row['min_max_price']['special_price']) && $product_row['min_max_price']['special_price'] != '' && $product_row['min_max_price']['special_price'] != 0 && $product_row['min_max_price']['special_price'] < $product_row['min_max_price']['min_price']) { ?>
                                                ...
                                                <?php if ($product_row['is_on_sale'] == 1) { ?>
                                                    <span class="product-discount-label"><?= $product_row['sale_discount'] ?>%</span>
                                                <?php } else { ?>
                                        ...
                                        <div itemscope itemtype="https://schema.org/Product">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <div itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                                                    ...
                                                    <?php if ($product_row['is_on_sale'] == 1) { ?>
                                                        <meta itemprop="price" content="<?= $product_row['variants'][0]['sale_final_price']; ?>" />
                                                    <?php } else { ?>
                                                        <meta itemprop="price" content="<?= $product_row['variants'][0]['price']; ?>" />
                                                    <?php } ?>
                    ...
                    <div class="col-md-4 col-12 style-3-product-right-lg">
                        <div class="product-grid">
                            ...
                            <div itemscope itemtype="https://schema.org/Product">
                                ...
                                <?php } ?>
                                <div class="product-content">
                                    <h2 class="title" title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', ($first_product['name']))) ?>" itemprop="name">
                                        <a href="<?= base_url('products/details/' . $first_product['slug']) ?>"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', word_limit($first_product['name']))) ?></a>
                                    </h2>
                                    <div itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                            ...
                            <?php if ($key != 0) { ?>
                                <div class="col-md-4 col-6">
                                    <div class="product-grid">
                                        ...
                                        <div class="product-content">
                                            <h2 class="title" title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', ($product_row['name']))) ?>">
                                                <a href="<?= base_url('products/details/' . $product_row['slug']) ?>"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', word_limit($product_row['name']))) ?></a>
                                            </h2>
                                            <div class="mb-1">
                                                <?php if (($product_row['variants'][0]['special_price'] < $product_row['variants'][0]['price']) && ($product_row['variants'][0]['special_price'] != 0)) { ?>
                                                    <p class="mb-2 mt-2">
    ...
    <?php if (isset($web_settings['app_download_section']) && $web_settings['app_download_section'] == 1) { ?>
        <div class="container-fluid mobile-app call-to-action-section product-section pt-4 pb-4 bg-white mt-4 mb-2">
            <div class="row">
...
<?php if (isset($id) && !empty($id)) { ?>
    <div class="modal fade" id="offer_popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-transparent bg-transparent border-color-transparent">

                <div class="modal-body modal_border_none cursor-pointer pt-0" onclick="location.href='<?= base_url('products/manage_popup_offers/' . $id) ?>'">
