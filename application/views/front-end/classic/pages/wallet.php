            ...
            <div class="col-md-8 col-12">
                <div class='card border-0'>
                    <div class="card-header bg-white">
                        <div class="row">
                            <h1 class="h4 col-6"><?= !empty($this->lang->line('wallet')) ? $this->lang->line('wallet') : 'Wallet' ?></h1>
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class='card col-md-12'>
                                    <div class='card-body bg-transparent'>
                                        ...
                                        <div class="h4 d-flex justify-content-center mt-2">
                                            <button type="button" class="button button-rounded button-primary" data-toggle="modal" data-target="#myModal"><?= label('add_money', 'Add money') ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 row">
                                <div class='card col-md-12 ml-3'>
                                    <div class='card-body bg-transparent'>
                                        <div class="h4 d-flex justify-content-center mt-2">
                                            <button type="button" class="button button-rounded button-danger" data-toggle="modal" data-target="#withdraw"><?= label('withdraw_money', 'Withdraw Money') ?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content card">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title price"><?= label('add_money_to_wallet', 'Add money to wallet') ?></h4>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php if (isset($payment_methods['phonepe_payment_method']) && $payment_methods['phonepe_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    <td class="border-none">
                                                                        <label for="phonepe">
                                                                            <input id="phonepe" name="payment_method" type="radio" value="phonepe" required>
                                                                        </label>
                                                                    </td>
                                                                    <td class="border-none">
                                                                        <label for="phonepe">
                                                            ...
                                                            <?php if (isset($payment_methods['instamojo_payment_method']) && $payment_methods['instamojo_payment_method'] == 1) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="border-none">
                                                                        <label for="instamojo">
                                                                            <img src="<?= THEME_ASSETS_URL . 'images/instamojo.png' ?>" class="payment-gateway-images height-30px" alt="instamojo">
                                                                        </label>
                                                                    </td>
                            ...
                            <div class="modal" id="withdraw">
                                <div class="modal-dialog">
                                    <div class="modal-content card">
                                        ...
                                        <!-- Modal Header -->
                                        <div class="modal-header">
                                            <h4 class="modal-title price"><?=label('withdraw_money','Withdraw Money')?></h4>
                                        </div>
                                        <!-- Modal body -->
                                        <div class="ship-details-wrapper mt-3 payment-methods">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#wallet_transaction"><?= label('wallet_transaction', 'Wallet Transaction') ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#withdrawal_requests"><?= label('wallet_requests', 'Wallet Requests') ?></a>
                        </li>
                    </ul>
...
<script src="<?= base_url('assets/front_end/classic/js/wallet.js') ?>"></script>