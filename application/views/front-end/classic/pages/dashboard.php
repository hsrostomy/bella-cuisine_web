    ...
    <div class="main-content">
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8 col-12 row">
                ...
                <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                    <a href='<?= base_url('my-account/delete_user') ?>' class="link-color">
                        <div class='card-header bg-transparent'>
                            <?= !empty($this->lang->line('delete_account')) ? $this->lang->line('delete_account') : 'Delete Account' ?>
                        </div>
                        <div class='card-body'>
                            <i class="fas fa-trash-alt dashboard-icon link-color fa-lg"></i>
                        </div>
                    </a>
                </div>
                <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                    <a href='<?= base_url('my-account/tickets') ?>' class="link-color">
                        <div class='card-header bg-transparent'>
                            <?= !empty($this->lang->line('customer_support')) ? $this->lang->line('customer_support') : 'Customer support' ?>
                        </div>
                        <div class='card-body'>
                            <i class="fas fa-headset dashboard-icon link-color fa-lg"></i>
                        </div>
                    </a>
                </div>
            </div>
