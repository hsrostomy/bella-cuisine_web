        ...
        <div class="row">
            <div class="col-md-8 mt-5 bg-white">
                <div class="cart-table-wrapper">
                    ...
                    <table id="cart_item_table" class="table table-responsive-sm table-cart-product">
                        <thead>
                            <tr>
                                            ...
                                            <div class="num-block skin-2 product-quantity">
                                                ...
                                                <?php } else { ?>
                                                    <div class="num-in">
                                                        ...
                                                        <span class="plus" data-max="<?= (isset($row['total_allowed_quantity']) && !empty($row['total_allowed_quantity'])) ? $row['total_allowed_quantity'] : '1' ?> " data-step="<?= (isset($row['minimum_order_quantity']) && !empty($row['quantity_step_size'])) ? $row['quantity_step_size'] : 1 ?>"></span>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </td>
            ...
            <div class="col-md-4 mt-5">
                <div class="cart-product-summary">
                    <h3> <?=label('cart_totals','Cart Totals')?></h3>
