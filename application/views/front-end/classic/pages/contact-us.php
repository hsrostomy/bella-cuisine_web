    ...
    <div class="main-content responsive-breadcrumb">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><?= !empty($this->lang->line('contact_us')) ? $this->lang->line('contact_us') : 'Contact Us' ?></li>
            </ol>
        </nav>
    </div>
</section>
                ...
                <form id="contact-us-form" action="<?= base_url('home/send-contact-us-email') ?>" method="POST">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="inputEmail4" name="username" placeholder="<?= !empty($this->lang->line('username')) ? $this->lang->line('username') : 'User Name' ?>">
                        </div>
                        <div class="form-group col-md-6">
            ...
            <?php if (isset($web_settings['support_email']) && !empty($web_settings['support_email'])) { ?>
                <div class="col-sm-6 col-md-4">
                    <div class="info-wrapper">  
                        ...
                        <div class="info-content">
                            <h3><?= !empty($this->lang->line('mail_us')) ? $this->lang->line('mail_us') : 'Mail us' ?>
