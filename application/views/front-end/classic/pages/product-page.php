...
<section class="content main-content product-page-content my-3 py-3" itemscope itemtype="https://schema.org/Product">
    <div class="row mx-0">
        ...
        <div class="col-12 col-md-6 product-page-details">
            <h2 class="my-3 product-title " itemprop="name">
            ...
            if (isset($settings['city_wise_deliverability']) && $settings['city_wise_deliverability'] == 1 && $shiprocket_settings['shiprocket_shipping_method'] != 1) { ?>
                <form class="mt-2" id="validate-city-form" method="POST">
                    <div class="form-row">
                        ...
                        <button type="submit" class="button button-primary-outline" id="validate_city">Check Availability</button>
                    </div>
                    <div class="mt-2" id="error_box">
                        <?php if (!empty($product['product'][0]['zipcode'])) { ?>
                            <b class="text-<?= ($product['product'][0]['is_deliverable']) ? "success" : "danger" ?>">Product is <?= ($product['product'][0]['is_deliverable']) ? "" : "not" ?> delivarable on &quot; <?= $product['product'][0]['zipcode']; ?> &quot; </b>
            ...
            <div class="pt-3 text-md-left">
                ...
                <?php } ?>
                <a href="https://api.whatsapp.com/send?phone= <?= ($settings['whatsapp_number'] != '' && isset($settings['whatsapp_number'])) ? $settings['whatsapp_number'] : ((!defined('ALLOW_MODIFICATION') && ALLOW_MODIFICATION == 0)  ? str_repeat("X", strlen($settings['whatsapp_number']) - 3) . substr($settings['whatsapp_number'], -3) : $settings['whatsapp_number'])   ?> &amp;text=Hello, I Seen This <?= $product['product'][0]['name'] ?> In Your Website And I Want to Buy This" target="_blank" title="Order From Whatsapp"><button class="buttons btn-6-4 extra-small m-0"><i class="fa-brands fa-whatsapp mr-2"></i><?= label('order_from_whatsapp', 'Order From Whatsapp') ?></button></a>
            </div>
            ...
            <?php if (isset($product['product'][0]['brand']) && !empty($product['product'][0]['brand'])) { ?>
                <div class="mt-2">
                    ...
                    <span class="badge badge-secondary p-1"><?= $brand ?>
        ...
        <div class="col-12 row mt-4">
            ...
            <nav class="w-100">
                <div class="nav nav-tabs" id="product-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link product-nav-tab" id="product-faq-tab" data-toggle="tab" href="#product-faq" role="tab" aria-controls="product-faq" aria-selected="false"><?= !empty($this->lang->line('FAQs')) ? $this->lang->line('FAQs') : 'FAQs' ?></a>
                </div>
            </nav>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12 description">
                                <?php echo (isset($product['product'][0]['description']) && !empty($product['product'][0]['description'])) ? ($product['product'][0]['description']) : ""  ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle"><?= !empty($this->lang->line('add_faq')) ? $this->lang->line('add_faq') : 'Add FAQ' ?></h5>
