...
<ul class="nav nav-pills nav-justified flex-column bg-white rounded shadow p-3 mb-0 my-account-tab" id="pills-tab" role="tablist">
    ...
    <li class="nav-item mt-2">
        <a class="nav-link rounded <?= ($current_url == base_url('my-account/tickets')) ? 'active' : '' ?>" id="transaction-details" href="<?= base_url('my-account/tickets') ?>">
            <div class="text-left py-1 px-3 sidebar-text">
                <h6 class="mb-0">
                    <i class="fas fa-headset fa-lg left-aside"></i> <?= !empty($this->lang->line('customer_support')) ? $this->lang->line('customer_support') : 'Customer Support' ?>
                </h6>
            </div>
        </a>
    </li>
    ...
    <li class="nav-item mt-2">
        <a class="nav-link rounded <?= ($current_url == base_url('my-account/delete_user')) ? 'active' : '' ?>" id="transaction-details" href="<?= base_url('my-account/delete_user') ?>">
            <div class="text-left py-1 px-3 sidebar-text">
                <h6 class="mb-0">
                    <i class="fas fa-trash fa-lg left-aside"></i> <?= !empty($this->lang->line('delete_account')) ? $this->lang->line('delete_account') : 'Delete Account' ?>
                </h6>
            </div>
        </a>
    </li>
    ...
    <li class="nav-item mt-2">
        <a class="nav-link rounded <?= ($current_url == base_url('my-account/refer_and_earn')) ? 'active' : '' ?>" id="transaction-details" href="<?= base_url('my-account/refer_and_earn') ?>">
            <div class="text-left py-1 px-3 sidebar-text">
                <h6 class="mb-0">
                    <i class="fa fa-money-bill fa-lg left-aside"></i> <?= !empty($this->lang->line('refer_and_earn')) ? $this->lang->line('refer_and_earn') : 'Refer and earn' ?>
                </h6>
            </div>
        </a>
    </li>
