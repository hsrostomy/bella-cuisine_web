            ...
            <div class="col-md-8 col-12">
                <div class='card border-0'>
                    <div class="card-header bg-white">
                        <h1 class="h4"><a href="#"><?= !empty($this->lang->line('address')) ? $this->lang->line('address') : 'Address' ?></h1>
                    </div>
                    <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form" class="mt-4 p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="number" class="form-control" id="mobile_number" name="mobile" placeholder="<?= !empty($this->lang->line('mobile_number')) ? $this->lang->line('mobile_number') : 'mobile_number' ?>" />
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="number" class="form-control" id="alternate_mobile" name="alternate_mobile" placeholder="<?= !empty($this->lang->line('alternate_mobile')) ? $this->lang->line('alternate_mobile') : 'Alternate_mobile' ?>" />
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label for="address" class="control-label"><?= !empty($this->lang->line('address')) ? $this->lang->line('address') : 'Address' ?></label>
                                <textarea name="address" class="form-control" id="address" cols="30" rows="4" placeholder="<?= !empty($this->lang->line('address')) ? $this->lang->line('address') : 'Address' ?>"></textarea>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group area">
                                <label for="area" class="control-label"><?=label('area','Area')?></label>
                                <input type="text" class="form-control" id="area" name="general_area_name" placeholder="<?= !empty($this->lang->line('area')) ? $this->lang->line('area') : 'Area Name' ?>" />
                            </div>
                            <!-- <div class="col-md-6 col-sm-12 col-xs-12 form-group area">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group area_name d-none">
                                <label for="area" class="control-label">Area</label>
                                <input type="text" class="form-control " id="area_name" name="area_name" placeholder="<?= !empty($this->lang->line('area_name')) ? $this->lang->line('area_name') : 'Area Name' ?>" />
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                <input type="submit" class="btn btn-primary" id="save-address-submit-btn" value="<?= !empty($this->lang->line('save')) ? $this->lang->line('save') : 'Save' ?> "/>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                        ...
                        "ignoreColumn": ["operate"] 
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="area" data-sortable="false"><?= !empty($this->lang->line('area')) ? $this->lang->line('area') : 'Area' ?></th>
