...
<!-- <script src="<?//= base_url('assets/front_end/classic/js/dropzone.js') ?>"></script> -->
<script src="<?= base_url('assets/front_end/classic/js/stisla.js') ?>"></script>


<!-- Custom -->
<script type="module" src="<?= THEME_ASSETS_URL . 'js/custom.js' ?>"></script>
