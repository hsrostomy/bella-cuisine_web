...
<div id="mySidenav" class="sidenav is-closed-left">
    <div class="container">
        <div class="row my-2 pr-2 text-uppercase d-flex align-items-center">
            <div class="col-12 text-right close-sidenav cart-sidebar-div"> <a href='#'><?= !empty($this->lang->line('close')) ? $this->lang->line('close') : 'Close' ?> <i class="fa fa-times"></i></a></div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <aside class="sidebar">
                <div id="leftside-navigation" class="nano">
                    <ul class="nano-content">
                        ...
                        <li><a href="<?= base_url('products/offers_and_flash_sale') ?>"><i class="fas fa-bolt fa-lg"></i> <span><?= !empty($this->lang->line('offers & flash sale')) ? $this->lang->line('offers & flash sale') : 'Offers & Flash Sale' ?></span></a></li>
...
<div class="shopping-cart-sidebar is-closed-right bg-white">
    ...
    <div class="container header ">
        <div class="row my-2 text-uppercase d-flex align-items-center">
            ...
            <div class="col-4 text-right close-sidebar cart-sidebar-div"> <a href='#' ><?= !empty($this->lang->line('close')) ? $this->lang->line('close') : 'Close' ?> <i class="fa fa-times"></i></a></div>
        </div>
    </div>
    <hr class="m-0">
...
<div class='block-div cart-sidebar-div' ></div>
<header id="header" class="topper-white header-varient">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white main-content">
        <button class="navbar-toggler border-0 open-navbar-mobile" type="button">
        ...
        <?php } else { ?>
            <a class="shopping-cart-sidebar-btn d-none" href="#" >
                <i class="fa-cart fa-cart-plus fas link-color"></i>
            </a>
        <?php } ?>
            ...
            <div class="col-md-6 d-flex justify-content-end px-0">
                <div class="navbar-nav">
                    ...
                    <?php if ($this->ion_auth->logged_in()) { ?>
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg">
                                ...
                                <a href="<?= base_url('my-account/delete_user') ?>" class="dropdown-item delete_user"><i class="fa fa-trash-alt mr-2 text-primary link-color"></i><?= !empty($this->lang->line('delete_account')) ? $this->lang->line('delete_account') : 'Delete Account' ?></a>
                                <a href="<?= base_url('my-account/refer_and_earn') ?>" class="dropdown-item refer_and_earn"><i class="fa fa-money-bill mr-2 text-primary link-color"></i><?= !empty($this->lang->line('refer_and_earn')) ? $this->lang->line('refer_and_earn') : 'Refer And Earn' ?></a>
                    ...
                    <li class="nav-item active">
                        <a href="<?= base_url('my-account/favorites') ?>" class="p-2 header-icon" id="view_favorites">
                    ...
                    <?php } else { ?>
                        <li class="nav-item active">
                            <a href="javascript:void(0);" class="p-2 header-icon shopping-cart-sidebar-btn" >
                                <i class="fa-cart fa-cart-plus fa-lg fas link-color"></i>
                                <span class="badge badge-danger badge-sm" id='cart-count'><?= (count($this->cart_model->get_user_cart($this->session->userdata('user_id'))) != 0 ? count($this->cart_model->get_user_cart($this->session->userdata('user_id'))) : ''); ?></span>
                            </a>
                        </li>
                            ...
                            <div class="cd-morph-dropdown cd-dp">
                                ...
                                <nav class="main-nav">
                                    <ul>
                                        ...
                                        <li class="morph-text">
                                            <a href="<?= base_url('products/offers_and_flash_sale') ?>"><?= label('top_offer', 'Top Offers') ?></a>
                                        </li>
                                        <li class="morph-text">
