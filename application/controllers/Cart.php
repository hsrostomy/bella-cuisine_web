...
class Cart extends CI_Controller
{
    ...
    public function manage()
    {
        if ($this->data['is_logged_in']) {
            ...
            // print_R(gettype($product_variant_id[0]));
            // return;
            ...
            //     $product_detail = fetch_details('product_variants', ['id' => $_POST['product_variant_id']], 'weight');
            //     $pro_weight = $product_detail[0]['weight'] * $_POST['qty'];
            //     if ($pro_weight > 15) {
            //         $this->response['error'] = true;
            //         $this->response['message'] = 'More than 15kg weight is not allowed !';
            //         $this->response['data'] = array();
            //         print_r(json_encode($this->response));
            //         return;
            //     }
    ...
    public function pre_payment_setup()
    {
        ...
        if ($this->data['is_logged_in']) {
            ...
            if ($_POST['payment_method'] == "Razorpay") {
                ...
                $order = $this->stripe->create_payment_intent(array('amount' => intval($overall_amount * 100)));
