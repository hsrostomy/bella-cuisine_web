...
class Home extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model(['address_model', 'category_model', 'cart_model', 'faq_model', 'brand_model']);
    ...
    public function send_contact_us_email()
    {
        ...
        $sender_mail = $this->input->post('email', true);
        ...
        $email_message = "Username : " . $username . "<br>"
            ...
            . "Subject : " . $subject . "<br>"
            . "Message : " . $message . "<br>";
        $mail = send_mail($to, $subject, $email_message, $sender_mail);
        if ($mail['error'] == true) {
            $this->response['error'] = true;
