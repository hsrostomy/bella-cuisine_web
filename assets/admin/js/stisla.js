...
(function ($, window, i) {
    ...
    $.chatCtrl = function (element, chat, direction = 'top') {
        ...
        if (chat.position == 'chat-right') {
            ...
            if (!!chat.media_files) {
                ...
                $.each(chat.media_files, function (key, val) {
                    // console.log(base_url + 'uploads/chat_media/' + val['original_file_name']);
            ...
            if (!!chat.media_files) {
                $.each(chat.media_files, function (key, val) {
                    if (val['file_extension'] == 'image/jpg' || val['file_extension'] == 'image/png' || val['file_extension'] == 'image/jpeg') {
                        ...
                        media_files += '<span class="chat-image-view"><a href="https://eshop.wrteam.co.in/uploads/chat_media/1.png" class="download-btn-styling download-msg fas fa-download"></a><img width="150px" src="' + base_url + 'uploads/chat_media/' + val['original_file_name'] + '" draggable="false"></span>';
                    } else {
        ...
        if (media_files!='') {
            var message_div ='<span class="msg_text_media">' + person_group_chat +  media_files + '</span>';
        } else {
            var message_div ='<span class="msg_text_media">' + person_group_chat + ' ' + chat.text + ' ' + media_files + '</span>';
        }
